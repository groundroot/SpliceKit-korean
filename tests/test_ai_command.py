...
TESTS = {
    ...
    "blade": [
        ...
        ("3초에서 잘라",
         ...
         "blade ko: cut at 3s"),
        ("10초마다 잘라",
         expect_all(expect_seek(10, 2), expect_timeline("blade")),
         "blade ko: every 10s"),
    ],
    ...
    "effects": [
        ...
        ("흑백으로 바꿔",
         ...
         "effect ko: b&w"),
        ("크로스 디졸브 추가",
         expect_any_of(expect_transition("Cross Dissolve"), expect_effect(), expect_timeline("addTransition")),
         "transition ko: cross dissolve"),
        ("add noise reduction",
